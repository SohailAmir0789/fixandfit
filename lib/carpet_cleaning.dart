                  ...
                  child: GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: const Column(
                        ...
                        children: [
                          Text('Fixed Carpet', style: TextStyle(fontSize: 14)),
                          Text(
                            'Carpet can not be removed',
                    ...
                    child: Container(
                      ...
                      child: const Padding(
                        ...
                        child: Column(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            Text('Open Carpet', style: TextStyle(fontSize: 14)),
                            Text(
                              'Carpet can be removed',
