...
class CurtainCleaning extends StatefulWidget {
  const CurtainCleaning({super.key});

  @override
  State<CurtainCleaning> createState() => _CurtainCleaningState();
}

final _formkey = GlobalKey<FormState>();

class _CurtainCleaningState extends State<CurtainCleaning> {
                ...
                child: GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: const Column(
                      children: [
                        Image(
                          image: AssetImage('assets/images/1cur.png'),
                          height: 50,
                          width: 90,
                        ),
                        Text('Small Panel '),
                  ...
                  child: Container(
                    ...
                    child: const Padding(
                      ...
                      child: Column(
                        children: [
                          Image(
                            image: AssetImage('assets/images/2cur.png'),
                            height: 50,
                            width: 90,
                          ),
                          Text('Medium Panel '),
                ...
                child: Container(
                  ...
                  child: const Padding(
                    ...
                    child: Column(
                      children: [
                        Image(
                          image: AssetImage('assets/images/3cur.png'),
                          height: 50,
                          width: 90,
                        ),
                        Text('Double Panel '),
