...
class OvenRepair extends StatefulWidget {
  const OvenRepair({super.key});

  @override
  State<OvenRepair> createState() => _OvenRepairState();
}

final _formkey = GlobalKey<FormState>();

class _OvenRepairState extends State<OvenRepair> {
                ...
                child: GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: const Column(
                      children: [
                        Image(
                          image: AssetImage('assets/images/oven.png'),
                          height: 60,
                          width: 90,
                        ),
                        Text('Single Oven'),
                  ...
                  child: Container(
                    ...
                    child: const Padding(
                      ...
                      child: Column(
                        children: [
                          Image(
                            image: AssetImage('assets/images/stoveoven.png'),
                            height: 60,
                            width: 90,
                          ),
                          Text('Microwave Oven'),
                ...
                child: GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: const Column(
                      children: [
                        Image(
                          image: AssetImage('assets/images/oven1.png'),
                          height: 60,
                          width: 90,
                        ),
                        Text(' Cooking Range'),
                ...
                child: GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: const Center(
                        child: Image(
                            image:
                                AssetImage('assets/images/mitsubishi1.png'))),
                  ),
                ),
              ),
              Padding(
                ...
                child: GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: const Center(
                        child: Image(
                            image: AssetImage('assets/images/bosch1.png'))),
                  ),
                ),
              ),
            ]),
              ...
              Padding(
                ...
                child: GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: const Center(
                        child: Image(
                            image: AssetImage('assets/images/hoover1.png'))),
                  ),
                ),
              ),
              Padding(
                ...
                child: GestureDetector(
                  ...
                  child: Container(
                      ...
                      child: const Column(
                        ...
                        children: [
                          Center(child: Text('Other Companies')),
                        ],
                      )),
                ),
              ),
